...
function Frame8() {
  return (
    <div className="blur-[2px] content-stretch flex gap-[24px] items-center opacity-10 relative shrink-0 w-full">
      <Frame10 />
      <Frame9 />
    </div>
  );
...
function Frame4() {
  return (
    <div className="-translate-x-1/2 absolute bg-[rgba(255,255,255,0.05)] content-stretch flex items-center left-[calc(50%-265px)] px-[8px] py-[4px] rounded-[4px] top-[524px]">
      <div className="flex flex-col font-inter font-medium justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] whitespace-nowrap">
        <p className="leading-[normal]">REFLECT AGAIN IN 12:30:38</p>
      </div>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#ede9e5] gap-[48px] items-center justify-center p-[48px] relative size-full to-[#dad3cd]" data-name="Desktop - 20">
      <Frame1 />
      <Frame4 />
    </div>
  );
