...
function Frame10() {
  return (
    <div className="bg-[rgba(255,255,255,0.9)] content-stretch flex flex-col items-center justify-center px-[16px] py-[8px] relative rounded-[3px] shrink-0 w-[35px]">
      ...
      <p className="font-inter font-normal leading-[normal] not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">1</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-inter font-medium gap-[4px] items-start leading-[0] min-h-px min-w-px not-italic relative">
      ...
      <div className="flex flex-col justify-center min-w-full relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] w-[min-content]">
        <p className="leading-[normal] whitespace-pre-wrap">Explore a past journal entry and uncover insights or patterns you couldn’t see at the time</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-inter font-medium gap-[4px] items-start leading-[0] min-h-px min-w-px not-italic relative">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] w-full">
        <p className="leading-[normal] whitespace-pre-wrap">Record your current thoughts and feelings to build your ongoing personal archive</p>
      </div>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#ede9e5] items-center justify-center p-[48px] relative size-full to-[#dad3cd]" data-name="Desktop - 15">
      <Frame1 />
    </div>
  );
}