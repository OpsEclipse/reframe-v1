...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[16px] py-[8px] relative rounded-[3px] shrink-0 w-[35px]">
      ...
      <p className="font-manrope font-normal leading-[normal] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.8)]">1</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-manrope font-medium gap-[4px] items-start leading-[0] min-h-px min-w-px relative">
      ...
      <div className="flex flex-col justify-center min-w-full relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] w-[min-content]">
        <p className="leading-[1.5] whitespace-pre-wrap">Explore a past journal entry and uncover insights or patterns you couldn’t see at the time</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[16px] py-[8px] relative rounded-[3px] shrink-0 w-[35px]">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <p className="font-manrope font-normal leading-[normal] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.8)]">2</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-medium gap-[4px] items-start leading-[0] min-h-px min-w-px relative">
      <div className="flex flex-col font-inter justify-center not-italic relative shrink-0 text-[16px] text-[rgba(255,255,255,0.9)] w-full">
        <p className="leading-[normal] whitespace-pre-wrap">WRITE</p>
      </div>
      <div className="flex flex-col font-manrope justify-center relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] w-full">
        <p className="leading-[1.5] whitespace-pre-wrap">Record your current thoughts and feelings to build your ongoing personal archive</p>
      </div>
    </div>
  );
}
      ...
      <div className="content-stretch flex items-center justify-center relative rounded-[12px] shrink-0 size-[40px]" data-name="App">
        <div className="relative shadow-[0px_0px_2px_0px_rgba(0,0,0,0.15),0px_16px_40px_0px_rgba(0,0,0,0.08)] shrink-0 size-[32px]" data-name="App / Default">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
            <path d={svgPaths.p3ac96b00} fill="var(--fill-0, white)" fillOpacity="0.5" id="Shape" stroke="url(#paint0_linear_1_2013)" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_2013" x1="12.8571" x2="28.7293" y1="4.29571e-07" y2="19.535">
...
export default function Desktop() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#ede9e5] items-center justify-center p-[48px] relative size-full to-[#dad3cd]" data-name="Desktop - 5">
      <Frame1 />
    </div>
  );
}