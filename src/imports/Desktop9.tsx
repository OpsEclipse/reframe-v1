  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[384px]">
      <div className="flex flex-col font-inter font-medium justify-center leading-[0] not-italic relative shrink-0 text-[20px] text-[rgba(255,255,255,0.9)] tracking-[-0.3px] w-full">
        <p className="leading-[1.5] whitespace-pre-wrap">If the version of you from February 2025 could see today’s entries, what would he admit he was wrong about?</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-[rgba(255,255,255,0.9)] content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[8px] relative rounded-[3px] shrink-0">
      ...
      <p className="font-inter font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-black">START REFLECTION</p>
...
export default function Desktop() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#ede9e5] items-center justify-center p-[48px] relative size-full to-[#dad3cd]" data-name="Desktop - 9">
      <Frame1 />
    </div>
  );
}